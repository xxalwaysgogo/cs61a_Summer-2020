...
def subseqs(s):
    ...
    if not s:
        ...
        all_but_first_element = subseqs(s[1:])
        return all_but_first_element + insert_into_all(s[0], all_but_first_element)
...
def make_glookup(class_assignments):
    ...
    "*** YOUR CODE HERE ***"
    weights, score = 0, 0
    def add(section, grade):
        assert section in class_assignments
        nonlocal weights, score
        score = score + grade
        weights = weights + class_assignments[section]
