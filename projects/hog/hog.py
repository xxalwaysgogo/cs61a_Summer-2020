...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(*score):
        ...
        if gain > running_high:
            ...
            return announce_highest(who, score[who], gain)
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    mkav = make_averaged(roll_dice, trials_count)
    trials = [mkav(i, dice) for i in range(1, 11)]
